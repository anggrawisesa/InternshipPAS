                                ...
                                <div class="p-2 mt-4">
                                    <form id="registerForm" class="needs-validation" novalidate method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input name="email" value="{{ old('email') }}" type="email" class="form-control" id="useremail" placeholder="Enter email address" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input id="password-confirm" type="password" class="form-control pe-5 password-input" name="password_confirmation" placeholder="Enter password" required autocomplete="new-password">
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none shadow-none text-muted password-addon" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                                                <div class="invalid-feedback">
